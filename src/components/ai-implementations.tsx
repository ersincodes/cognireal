      ...
      <div className="relative w-full max-w-[1400px]">
        <div ref={contentRef} className="flex flex-col items-end text-right">
          ...
          <Link
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-8 inline-block rounded-full bg-linear-to-r from-brand-cyan to-brand-blue px-10 py-3 text-lg font-medium text-white shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl"
