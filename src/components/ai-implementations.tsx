...
export default function AIImplementations() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative flex w-full justify-center bg-[#f5f5f5] px-4 py-24 md:px-12">
      <div
        ref={contentRef}
        className="relative z-10 flex w-full max-w-5xl flex-col items-end text-right">
        {/* WE IMPLEMENT label */}
        ...
        <p className="mt-6 max-w-lg text-base text-brand-dark/70 md:text-lg">
          Automated reports, intelligent chatbots, and custom automation systems
          that upgrade how your business works.
        </p>
